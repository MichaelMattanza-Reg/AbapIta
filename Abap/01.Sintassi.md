...
La reference crea un puntatore (field-symbol) che non può essere riassegnato. Sarà quindi fisso per quella cella di memoria.
Se si modificano i valori della reference verranno aggiornati i valori in memoria. E' consigliata per evitare eccessivi controlli di assegnazione come per i field-symbol.
